...
//		}
		//propsQnames.put(ContentModel.PROP_NAME, CO.AGR_PREFIX + new Date().getTime());
		...
		ChildAssociationRef agreement = nodeService.createNode(monthRef, ContentModel.ASSOC_CONTAINS, 
				QName.createQName(NamespaceService.CONTENT_MODEL_1_0_URI, CO.AGR_PREFIX + agr.getName()),
